    ...
    <main id="main-container" class="main">
        ...
        <div class="container mt-5 pt-4">
                ...
                <form id="alumniForm" action="{{ route('new-tracer.update', $tracer->id) }}" method="POST">
                    ...
                    <div class="form-section active" data-step="1">
                        <div class="section-header mb-4">
                            <h3 class="fw-bold mb-0 text-primary"><i class="fas fa-user-edit me-2"></i> Identitas Alumni
                            </h3>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="tahun_lulus" class="form-select @error('tahun_lulus') is-invalid @enderror"
                                    required>
                                    <option value="" disabled {{ old('tahun_lulus', $tracer->tahun_lulus) == '' ? 'selected' : '' }}>-- Pilih Tahun Lulus --</option>
                                    @php
                                        $currentYear = date('Y');
                                        $selectedYear = old('tahun_lulus', $tracer->tahun_lulus);
                                    @endphp
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nim"
                                    class="form-control bg-light @error('nim') is-invalid @enderror"
                                    value="{{ old('nim', $tracer->nim) }}" readonly>
                                @error('nim')
                                <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Program Studi</label>
                                <input type="text" name="prodi" class="form-control bg-light" value="Teknik Informatika"
                                    readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Alamat Lengkap</label>
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3"
                                    required>{{ old('alamat', $tracer->alamat) }}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    ...
                    <div class="form-section" data-step="2">
                        <div class="section-header mb-4">
                            <h3 class="fw-bold mb-0 text-primary"><i class="fas fa-briefcase me-2"></i> Status Aktivitas
                            </h3>
                        ...
                        <div class="custom-radio-group">
                            ...
                            <label class="custom-radio-item">
                                ...
                                <div class="radio-content">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold">Bekerja</h5><small class="text-muted">Karyawan Full-time /
                                            Part-time</small>
                                    </div>
                                </div>
                            </label>
                            <label class="custom-radio-item">
                                ...
                                <div class="radio-content">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold">Wirausaha</h5><small class="text-muted">Memiliki bisnis
                                            mandiri</small>
                                    </div>
                                </div>
                            </label>
                            <label class="custom-radio-item">
                                ...
                                <div class="radio-content">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold">Studi Lanjut</h5><small class="text-muted">Melanjutkan
                                            pendidikan resmi</small>
                                    </div>
                                </div>
                            </label>
                            <label class="custom-radio-item">
                                ...
                                <div class="radio-content">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold">Mencari Kerja</h5><small class="text-muted">Sedang mencari
                                            peluang baru</small>
                                    </div>
                                </div>
                            </label>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_perusahaan" class="form-control"
                                        value="{{ old('nama_perusahaan', $tracer->pekerjaan->nama_perusahaan ?? ($tracer->wirausaha->nama_usaha ?? '')) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Jabatan</label>
                                    <input type="text" name="jabatan" class="form-control"
                                        value="{{ old('jabatan', $tracer->pekerjaan->jabatan ?? ($tracer->wirausaha->posisi_usaha ?? '')) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Pendapatan (Rp)</label>
                                    <input type="number" name="pendapatan" class="form-control"
                                        value="{{ old('pendapatan', $tracer->pekerjaan->pendapatan ?? ($tracer->wirausaha->pendapatan_usaha ?? '')) }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="tingkat_usaha_level" class="form-select">
                                        ...
                                        <option value="multinasional" {{ $lvl == 'multinasional' ? 'selected' : '' }}>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_atasan" class="form-control"
                                    value="{{ old('nama_atasan', $tracer->pekerjaan->nama_atasan ?? '') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email_atasan" class="form-control"
                                    value="{{ old('email_atasan', $tracer->pekerjaan->email_atasan ?? '') }}"
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="universitas" class="form-control"
                                    value="{{ old('universitas', $tracer->pendidikan->universitas ?? '') }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Program Studi</label>
                                <input type="text" name="program_studi" class="form-control"
                                    value="{{ old('program_studi', $tracer->pendidikan->program_studi ?? '') }}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="waktu_cari_kerja" class="form-select">
                            <option value="sebelum_lulus" {{ $waktu == 'sebelum_lulus' ? 'selected' : '' }}>Sebelum Lulus
                            </option>
                            <option value="setelah_lulus" {{ $waktu == 'setelah_lulus' ? 'selected' : '' }}>Setelah Lulus
                            </option>
                            <option value="tidak_mencari" {{ $waktu == 'tidak_mencari' ? 'selected' : '' }}>Tidak Mencari
                            </option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Bulan tunggu bekerja</label>
                        <input type="number" name="bulan_kerja" class="form-control"
                            value="{{ old('bulan_kerja', $tracer->pekerjaan->bulan_kerja ?? '') }}">
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="{{ $key }}_awal" class="form-select">
                                            ...
                                            <option value="sangat_baik" {{ $val == 'sangat_baik' ? 'selected' : '' }}>Sangat Baik
                                            </option>
            ...
            <div class="form-section" data-step="6">
                ...
                <div class="upload-area p-5 text-center border-2 border-dashed rounded-4 bg-light mb-4 position-relative">
                    <div id="ai_loading" style="z-index: 10;"
                        ...
                        <button type="button" id="close_ai_loading" class="btn-close position-absolute top-0 end-0 m-3"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="saran" class="form-control"
                        rows="5">{{ old('saran', $tracer->evaluasiPendidikan->saran ?? '') }}</textarea>
                </div>
                <div class="alert alert-primary rounded-4">
                    <i class="fas fa-info-circle me-2"></i> Klik tombol di bawah untuk memperbarui data kuesioner Anda
                    secara permanen.
                </div>
            </div>
            ...
            <div class="wizard-nav">
                <button type="button" class="btn btn-wizard btn-prev"><i class="fas fa-arrow-left me-2"></i>
                    Sebelumnya</button>
                <button type="button" class="btn btn-wizard btn-next">Selanjutnya <i
                        class="fas fa-arrow-right ms-2"></i></button>
                <button type="submit" class="btn btn-wizard btn-submit" style="display:none;"><i
                        class="fas fa-save me-2"></i> Update Sekarang</button>
            </div>
            </form>
        </div>
        </div>
