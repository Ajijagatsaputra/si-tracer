                   ...
                   <li class="nav-main-item">
                       ...
                       <ul class="nav-main-submenu">
                           <li class="nav-main-item">
                               ...
                               <ul class="nav-main-submenu">
                                   @php
                                       $existingTracer = \App\Models\TracerStudy::where(
                                           'user_id',
                                           Auth::user()->id,
                                       )->first();
                                   @endphp
                                   <li class="nav-main-item">
                                       @if ($existingTracer)
                                           <a class="nav-main-link disabled"
                           ...
                           @php
                               ...
                               $tracerPengguna = null;
                               if ($tracerStudy) {
                                   $tracerPengguna = \App\Models\TracerPengguna::where(
                                       'tracer_study_id',
                                       $tracerStudy->id,
                                   )->first();
                               }
                           ...
                           @if ($tracerPengguna)
                               <li class="nav-main-item">
                                   ...
                                   @else
                                       <a class="nav-main-link disabled" href="#" tabindex="-1"
                                           aria-disabled="true">
                                           <span class="nav-main-link-name">Tracer Study Pengguna</span>
                                       </a>
                                   @endif
